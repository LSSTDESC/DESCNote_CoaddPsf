...
% Makes a footnote without putting any mark in the text.  Used for the Affiliations footnote, 
% since the OJA format doesn't put the mark in the right place.
...
\shortauthors{Mandelbaum et al.\ (LSST~DESC)}

\begin{document}
\title{PSFs of coadded images}

\author{Rachel Mandelbaum\altaffilmark{1}, Mike Jarvis\altaffilmark{2}, Robert H. Lupton\altaffilmark{3}, James Bosch\altaffilmark{3}, Arun Kannawadi\altaffilmark{3}, Michael D.\ Murphy\altaffilmark{1}, Tianqing Zhang\altaffilmark{1}}
\noaffiliation
...
\begin{abstract}
    ...
    \begin{enumerate}[leftmargin=2.0cm,rightmargin=1.3cm]
